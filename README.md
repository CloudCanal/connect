...
```html
<!-- Development -->
<script src="https://cdn.jsdelivr.net/gh/CloudCanal/cloud-canal-connect@main/dist/connect.js"></script>

<!-- Production (minified) -->
<script src="https://cdn.jsdelivr.net/gh/CloudCanal/cloud-canal-connect@main/dist/connect.min.js"></script>
```
